...
#define PACKET_SINGLE_RESULT_LENGTH      (PROTOCOL_EUI_SIZE + sizeof(int32_t) * (NUM_RANGING_BROADCASTS + 1))   // EUI + median + all ranging_data
#define PACKET_SINGLE_EXCHANGED_RESULT_LENGTH      (PROTOCOL_EUI_SIZE + sizeof(int32_t)) //new, for over the air glossy exchange
